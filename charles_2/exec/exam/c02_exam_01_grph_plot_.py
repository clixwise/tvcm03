...
from exam.c02_exam_01_grph_plot_scat import exec_plot_scat
from exam.c02_exam_01_grph_plot_heat import exec_plot_heat

# https://gemini.google.com/app/2bf3d6757a7f52d0 [the Scenario approach]

class PlotTranEXAM_01(PlotTran):
...
class PlotTranEXAM_01_hist(PlotTranANOM_01_hist):
...
class PlotTranEXAM_01_heat(PlotTranEXAM_01):
    ...
    def __init__(self, procTran): #, stat_tran, figu_tran, figu_axis):
        ...
        # Titl, Lgnd
        # ----
        self.titl = "CEAP R vs L"

    def upda(self):
        exec_plot_heat(self)
        pass 

class PlotTranEXAM_01_scat(PlotTranEXAM_01):

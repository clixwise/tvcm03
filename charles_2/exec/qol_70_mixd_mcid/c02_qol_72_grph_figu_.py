...
class FiguTranQOL_72_2x1(FiguTran2x1):
...
class FiguTranQOL_11b(FiguTranQOL_11_3x1):
    ...
    def upda(self):
        super().upda()
'''        
class FiguTranQOL_11c_mixd_mono(FiguTranQOL_72_2x1):
...
class FiguTranQOL_11c_mixd_dual(FiguTranQOL_72_2x1):
...
class FiguTranQOL_72_mean(FiguTranQOL_72_2x1):
    
    def __init__(self, procTran):
        super().__init__()
        procTran.dict[FiguTranQOL_72_mean.__name__] = self
        #
        self.name = FiguTranQOL_72_mean.__name__
        self.stra = None
...
class FiguTranQOL_71a_cohe(FiguTranQOL_72_2x1):
    
    def __init__(self, procTran):
        super().__init__()
        procTran.dict[FiguTranQOL_71a_cohe.__name__] = self
        #
        self.name = FiguTranQOL_71a_cohe.__name__

    def upda(self):
        super().upda()
        
class FiguTranQOL_71a_mcid(FiguTranQOL_72_2x1):
    
    def __init__(self, procTran):
        super().__init__()
        procTran.dict[FiguTranQOL_71a_mcid.__name__] = self
        #
        self.name = FiguTranQOL_71a_mcid.__name__

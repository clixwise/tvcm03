...
from qol_70_mixd_mcid.c02_qol_71_stat_mcid_copi_1 import exec_stat_mcid_copi_1
from qol_70_mixd_mcid.c02_qol_71_stat_mcid_copi_2 import exec_stat_mcid_copi_2
from util.data_02_proc import ProcTran
from qol_70_mixd_mcid.c02_qol_71_stat_adat import StatTranQOL_71_mcid_copi 

class StatTranQOL_71(StatTran):
    def __init__(self, proc_tran:ProcTran):
        super().__init__(StatTranQOL_71.__name__, proc_tran)
        #
        self.stat_tran_mcid_copi = StatTranQOL_71_mcid_copi(self)
...
class StatTranQOL_71_mcid_copi():
    def __init__(self, stat_tran:StatTranQOL_71):

...
from qol_70_mixd_mcid.c02_qol_71_stat_ import StatTranQOL_71, StatTranQOL_71_mcid_copi
...
def main_exec_qol_71_stat(procTran:ProcTranStatQOL71, inpuTran:InpuTran, oupuTran:OupuTranFile):
    ...
    # Stat.prec
    # ----
    def proc_fram_post(statTran:StatTranQOL_71, framTran:FramTran):
    ...
    # Stat.Exec
    # ----
    def proc_stat_exec(statTran:StatTranQOL_71):
        statTran.stra = 'a'
        statTran.upda()
        
    # Stat.Oupu
    # ----
    def proc_stat_oupu(statTran:StatTranQOL_71, oupuTran:OupuTranFile):
        oupuTran.fram_dict[StatTranQOL_71.__name__] = { "orig_fram" : { 'df':statTran.fram, 'mode':'md' } }
        oupuTran.fram_dict[StatTranQOL_71_mcid_copi.__name__] = {}
        oupuTran.upda()
        oupuTran.fram_dict = {}
    ...
    statTran = StatTranQOL_71(procTran)

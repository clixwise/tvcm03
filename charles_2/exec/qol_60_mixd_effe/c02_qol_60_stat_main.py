...
def main_exec_qol_61_stat(procTran:ProcTranStatQOL61, inpuTran:InpuTran, oupuTran:OupuTranFile):
    ...
    # Stat.prec
    # ----
    def proc_fram_post(statTran:StatTranQOL_61, framTran:FramTran):
    ...
    # Stat.Exec
    # ----
    def proc_stat_exec(statTran:StatTranQOL_61):
        statTran.stra = 'a'
        statTran.upda()
        
    # Stat.Oupu
    # ----
    def proc_stat_oupu(statTran:StatTranQOL_61, oupuTran:OupuTranFile):
        oupuTran.fram_dict[StatTranQOL_61.__name__] = { "orig_fram" : { 'df':statTran.fram, 'mode':'md' } }
        oupuTran.fram_dict[StatTranQOL_61_cohe.__name__] = { "cohe_modl" : { 'df':statTran.stat_tran_cohe.resu_cohe_modl_stat, 'mode':'md' } ,
                                                             "cohe_raww" : { 'df':statTran.stat_tran_cohe.resu_cohe_raww_stat, 'mode':'md' } }
        oupuTran.upda()
        oupuTran.fram_dict = {}
    ...
    statTran = StatTranQOL_61(procTran)

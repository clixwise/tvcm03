...
def main_exec_qol_31_stat(procTran:ProcTranStatQOL31, inpuTran:InpuTran, oupuTran:OupuTranFile):
    ...
    # Stat.prec
    # ----
    def proc_fram_post(statTran:StatTranQOL_31, framTran:FramTran):
    ...
    # Stat.Exec
    # ----
    def proc_stat_exec(statTran:StatTranQOL_31):
        statTran.stra = 'a'
        statTran.upda()
        
    # Stat.Oupu
    # ----
    def proc_stat_oupu(statTran:StatTranQOL_31, oupuTran:OupuTranFile):
        oupuTran.fram_dict[StatTranQOL_31.__name__] = {
        "orig_fram" : { 'df':statTran.fram, 'mode':'md' }
        }
        oupuTran.fram_dict[StatTranQOL_31_mixd.__name__] = {
        "mixd_mean_raww" : { 'df':statTran.stat_tran_mixd.mixd_mean_raww, 'mode':'md' },
        "mixd_mean_modl" : { 'df':statTran.stat_tran_mixd.mixd_mean_modl, 'mode':'md' },
        "mixd_mean_merg" : { 'df':statTran.stat_tran_mixd.mixd_mean_merg, 'mode':'md' },
        "mixd_emms_modl" : { 'df':statTran.stat_tran_mixd.mixd_emms_modl, 'mode':'md' },
        "mixd_pair_modl_1" : { 'df':statTran.stat_tran_mixd.mixd_pair_modl_1, 'mode':'md' },
        "mixd_pair_modl_2" : { 'df':statTran.stat_tran_mixd.mixd_pair_modl_2, 'mode':'md' },
        "mixd_assu_resi" :      { 'df':statTran.stat_tran_mixd.mixd_assu_resi, 'mode':'md' },
        "mixd_assu_rand" :      { 'df':statTran.stat_tran_mixd.mixd_assu_rand, 'mode':'md' },
        }
        oupuTran.upda()
        oupuTran.fram_dict = {}
    ...
    statTran = StatTranQOL_31(procTran)

...
if TYPE_CHECKING:
    from c02_qol_32_grph_plot_ import PlotTranQOL_32_mean_abso_dual_vert
...
def plot_mean_abso_dual_vert(plot_tran_mixd: PlotTranQOL_32_mean_abso_dual_vert) -> None:
    # from qol_30.c02_qol_32_grph_plot_ import PlotTranQOL_32_mean_abso_dual_vert
    ...
    '''
    '''
    df_orig = plot_tran_mixd.fram_dict["raww_mean_fram"] # workbook, date1, date2, timepoint, patient_id, name, none_m, none_z, none_t, ...
    df_fram = plot_tran_mixd.fram_dict["modl_mean_fram"] # "timepoint", "n", "mean", "ci_lower", "ci_upper", "modl_mean", "modl_ci_lower", "modl_ci_upper", ...
    df_orig = df_orig.copy()
    df_fram = df_fram.copy()
    if trac:
        print_yes(df_orig, labl="df_orig:raww_mean_fram")
        print_yes(df_fram, labl="df_fram:modl_mean_fram")

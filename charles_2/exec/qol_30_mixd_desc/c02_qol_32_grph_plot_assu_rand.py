...
if TYPE_CHECKING:
    from c02_qol_32_grph_plot_ import PlotTranQOL_32_assu_rand
...
def plot_assu_rand_ququ(plot_tran_mixd: PlotTranQOL_32_assu_rand) -> None:
    # from qol_30.c02_qol_32_grph_plot_ import PlotTranQOL_32_assu_rand

    trac = True

    # Data
    # ---- 
    df_assu_rand_plot = plot_tran_mixd.fram_dict["orig_fram"]
    print_yes(df_assu_rand_plot)
    '''
    patient_id       Group
    ...
    '''
    df_plot = df_assu_rand_plot.copy()
    if trac:
...
def plot_assu_rand_hist(plot_tran_mixd: PlotTranQOL_32_assu_rand) -> None:
    # from qol_30.c02_qol_32_grph_plot_ import PlotTranQOL_32_assu_rand

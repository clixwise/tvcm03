...
class FiguTranQOL_32_2x1(FiguTran2x1):
...
class FiguTranQOL_32_3x1(FiguTran3x1):
...
class FiguTranQOL_11b(FiguTranQOL_11_3x1):
    ...
    def upda(self):
        super().upda()
'''        
class FiguTranQOL_11c_mixd_mono(FiguTranQOL_32_2x1):
...
class FiguTranQOL_11c_mixd_dual(FiguTranQOL_32_2x1):
...
class FiguTranQOL_32_assu_rand(FiguTranQOL_32_2x1):
    
    def __init__(self, procTran):
        super().__init__()
        procTran.dict[FiguTranQOL_32_assu_rand.__name__] = self
        #
        self.name = FiguTranQOL_32_assu_rand.__name__
        self.stra = None

    def upda(self):
        super().upda()
        
class FiguTranQOL_32_assu_resi_1(FiguTranQOL_32_2x1):
    
    def __init__(self, procTran):
        super().__init__()
        procTran.dict[FiguTranQOL_32_assu_resi_1.__name__] = self
        #
        self.name = FiguTranQOL_32_assu_resi_1.__name__
        self.stra = None

    def upda(self):
        super().upda()
        
class FiguTranQOL_32_assu_resi_2(FiguTranQOL_32_3x1):
    
    def __init__(self, procTran):
        super().__init__()
        procTran.dict[FiguTranQOL_32_assu_resi_2.__name__] = self
        #
        self.name = FiguTranQOL_32_assu_resi_2.__name__
        self.stra = None

    def upda(self):
        super().upda()
        
class FiguTranQOL_32_mean(FiguTranQOL_32_2x1):
    
    def __init__(self, procTran):
        super().__init__()
        procTran.dict[FiguTranQOL_32_mean.__name__] = self
        #
        self.name = FiguTranQOL_32_mean.__name__
        self.stra = None

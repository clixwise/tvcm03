...
from vcss.c02_vcss_01_stat_ import StatTranVCSS_01, StatTranVCSS_01_mixd
...
from util.data_61_fram import FramTran, inpu_fram_exec_selc_1_exte, inpu_fram_exec_selc_1_inte, inpu_frax_exec_selc_1 

def main_exec_vcss_01_stat(procTran:ProcTranStatVCSS01, inpuTran:InpuTran, oupuTran:OupuTranFile):
    ...
    def proc_fram_inpu(framTran:FramTran, inpuTran: InpuTran):
        ...
        if work_inte:
            ...
            framTran.filt = ['M_Age', 'M_Sexe', 'V_R', 'V_L', 'V_P', 'V_VCSS_CEAP_R', 'V_VCSS_CEAP_L', 'V_R_List', 'V_L_List', 'V_R_Text', 'V_L_Text']
            framTran.pref = ("M_","V_")
        ...
        # Exec Limb
        # ----
        framTran.drop_list = ['P', 'VCSS_CEAP_R', 'VCSS_CEAP_L', 'R_List', 'L_List', 'R_Text', 'L_Text']
        framTran.func = inpu_frax_exec_selc_1
        framTran.upda_frax()

    # Stat.prec
    # ----
    def proc_fram_post_fram(statTran:StatTranVCSS_01, framTran:FramTran):
    ...
    def proc_fram_post_frax(statTran:StatTranVCSS_01, framTran:FramTran):
    ...
    def proc_fram_post(statTran:StatTranVCSS_01, framTran:FramTran):
        proc_fram_post_fram(statTran, framTran)
        proc_fram_post_frax(statTran, framTran)
    
    # Stat.Exec
    # ----
    def proc_stat_exec(statTran:StatTranVCSS_01):
        statTran.stra = 'a'
        statTran.upda()
        
    # Stat.Oupu
    # ----
    def proc_stat_oupu(statTran:StatTranVCSS_01, oupuTran:OupuTranFile):
        oupuTran.fram_dict[StatTranVCSS_01_desc.__name__] =  { "resu_publ" : { 'df':statTran.stat_tran_desc.resu_publ, 'mode':'md' },  "resu_tech" : { 'df':statTran.stat_tran_desc.resu_tech, 'mode':'md' } }
        oupuTran.fram_dict[StatTranVCSS_01_mixd.__name__] =  { "resu_plot" : { 'df':statTran.stat_tran_mixd.resu_plot, 'mode':'md' },  "resu_tech" : { 'df':statTran.stat_tran_desc.resu_tech, 'mode':'md' } }
        oupuTran.upda()
        oupuTran.fram_dict = {}
    ...
    statTran = StatTranVCSS_01(procTran)

...
def inpu(file_path):     
    ...
    df11 = df11.drop_duplicates(subset=['doss', 'age_bin', 'sexe'])
    df12 = df12.drop_duplicates(subset=['doss', 'age_bin', 'sexe'])
    df13 = df13.drop_duplicates(subset=['doss', 'age_bin', 'sexe'])
...
def ke15_pati_agbi_sexe_c3c6_full_abso():

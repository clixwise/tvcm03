...
from util_file_inpu_dual_mbas import inp1, inp2, inp3
...
def inpu(file_path, indx_name, indx_cate_list):     
    ...
    df_line21 = df_line21[~df_line21['mbas'].isin(['NA'])] # eliminate 'NA'  
    df_line22 = df_line22[~df_line22['mbas'].isin(['NA'])] # eliminate 'NA'
    df_line23 = df_line23[~df_line23['mbas'].isin(['NA'])] # eliminate 'NA'
            
    indx_name_stra = 'notused_stra' # 'sexe_stra'
    colu_name_ordi = 'notused_ordi' # 'age_bin_ordi'
